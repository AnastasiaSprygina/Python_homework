...
class GroupHelper:
    ...
    def fill_group_form(self, group):
        wd = self.app.wd
        self.change_data("group_name", group.name)
        self.change_data("group_header", group.header)
        self.change_data("group_footer", group.footer)

    def change_data(self, field_name, text):
        wd = self.app.wd
        if text is not None:
