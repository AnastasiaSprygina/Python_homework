...
def test_phones_on_home_page(app):
    ...
    assert contact_from_home_page.all_phones_from_homepage == merge_contacts_like_on_home_page(contact_from_edit_page)
...
def merge_contacts_like_on_home_page(contact):
